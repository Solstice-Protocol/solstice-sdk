 ...
 */
export const SOLSTICE_PROGRAM_ID = new PublicKey('8jrTVUyvHrL5WTWyDoa6PTJRhh3MwbvLZXeGT81YjJjz');
...
export const SUPPORTED_COUNTRIES = [
  'US', 'IN', 'UK', 'CA', 'AU', 'DE', 'FR', 'JP', 'KR', 'SG',
  'BR', 'MX', 'AR', 'CL', 'PE', 'CO', 'VE', 'UY', 'PY', 'BO',
  'EC', 'GY', 'SR', 'FK', 'GF', 'PF', 'NC', 'VU', 'FJ', 'SB',
  'PG', 'NR', 'TV', 'KI', 'MH', 'FM', 'PW', 'WS', 'TO', 'AS'
] as const;
